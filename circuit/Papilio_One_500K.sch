...
<drawing version="7">
    ...
    <netlist>
        ...
        <block symbolname="Quadrature_decoder" name="XLXI_41">
            ...
            <blockpin signalname="XLXN_505" name="Clk" />
        </block>
        <block symbolname="ZPUino_Papilio_One_500K_V2" name="XLXI_52">
            <blockpin signalname="XLXN_505" name="clk_96Mhz" />
    ...
    <sheet sheetnum="1" width="5440" height="3520">
        ...
        <branch name="XLXN_501(100:0)">
            <wire x2="496" y1="816" y2="976" x1="496" />
        </branch>
        <branch name="XLXN_502(100:0)">
            <wire x2="512" y1="816" y2="976" x1="512" />
        </branch>
        <instance x="384" y="1664" name="XLXI_41" orien="R0">
        </instance>
        <branch name="XLXN_505">
            <wire x2="368" y1="928" y2="1056" x1="368" />
            <wire x2="384" y1="1056" y2="1056" x1="368" />
            <wire x2="4736" y1="928" y2="928" x1="368" />
            <wire x2="4736" y1="480" y2="480" x1="4704" />
            <wire x2="4736" y1="480" y2="928" x1="4736" />
        </branch>
        <branch name="WING_AL0">
            <wire x2="384" y1="1120" y2="1120" x1="352" />
        </branch>
        <iomarker fontsize="28" x="352" y="1120" name="WING_AL0" orien="R180" />
        <branch name="WING_AL1">
            <wire x2="384" y1="1184" y2="1184" x1="352" />
        </branch>
        <iomarker fontsize="28" x="352" y="1184" name="WING_AL1" orien="R180" />
        <branch name="WING_AL2">
            <wire x2="384" y1="1248" y2="1248" x1="352" />
        </branch>
        <iomarker fontsize="28" x="352" y="1248" name="WING_AL2" orien="R180" />
        <branch name="WING_AL3">
            <wire x2="384" y1="1312" y2="1312" x1="352" />
        </branch>
        <iomarker fontsize="28" x="352" y="1312" name="WING_AL3" orien="R180" />
        <branch name="WING_AL4">
            <wire x2="384" y1="1376" y2="1376" x1="352" />
        </branch>
        <iomarker fontsize="28" x="352" y="1376" name="WING_AL4" orien="R180" />
        <branch name="WING_AL5">
            <wire x2="384" y1="1440" y2="1440" x1="352" />
        </branch>
        <iomarker fontsize="28" x="352" y="1440" name="WING_AL5" orien="R180" />
        <branch name="WING_AL6">
            <wire x2="384" y1="1504" y2="1504" x1="352" />
        </branch>
        <iomarker fontsize="28" x="352" y="1504" name="WING_AL6" orien="R180" />
        <branch name="WING_AL7">
            <wire x2="384" y1="1568" y2="1568" x1="352" />
        </branch>
        <iomarker fontsize="28" x="352" y="1568" name="WING_AL7" orien="R180" />
    </sheet>
</drawing>